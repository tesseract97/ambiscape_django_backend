"""
Django settings for ambiscape_django_backend project.
...
SECRET_KEY = 'k1a6-*5^%^c7w)(5&ls@*znj1lsh4et8)3*$is$=)v2_47y-1_'
...
INSTALLED_APPS = [
    ...
    'ambiscape.apps.AmbiscapeConfig'
]
...
ROOT_URLCONF = 'ambiscape_django_backend.urls'
